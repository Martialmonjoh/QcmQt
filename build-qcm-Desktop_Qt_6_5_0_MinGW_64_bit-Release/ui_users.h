...
public:
    ...
    void setupUi(QDialog *Users)
    {
        ...
        yes_btn->setGeometry(QRect(230, 230, 91, 31));
        yes_btn->setFont(font);
        yes_btn->setStyleSheet(QString::fromUtf8("background: white; border:1 px solid;border-radius:5px"));
        no_btn = new QPushButton(Users);
        no_btn->setObjectName("no_btn");
        no_btn->setGeometry(QRect(370, 230, 91, 31));
        no_btn->setFont(font);
        no_btn->setStyleSheet(QString::fromUtf8("background: white; border:1 px solid;border-radius:5px"));
        layoutWidget = new QWidget(Users);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(30, 90, 441, 111));
        ...
        lineEdit_user->setStyleSheet(QString::fromUtf8("background: white; border:1 px solid;border-radius:5px"));

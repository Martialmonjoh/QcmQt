...
public:
    ...
    void setupUi(QDialog *AdminPage)
    {
        ...
        AdminPage->setStyleSheet(QString::fromUtf8("background:rgb(85, 255, 255);"));
        ...
        add_etudiant->setStyleSheet(QString::fromUtf8("background:white;\n"
...
"border: 6px rgb(85, 255, 255);"));
        ...
        add_etudiant_2->setStyleSheet(QString::fromUtf8("background:white;\n"
"border: 6px rgb(85, 255, 255);"));
        ...
        make_test_2->setStyleSheet(QString::fromUtf8("background:white;\n"
"border: 6px rgb(85, 255, 255);"));

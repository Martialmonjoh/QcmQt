...
public:
    ...
    void setupUi(QDialog *AjoutEtudiant)
    {
        ...
        ajouter->setStyleSheet(QString::fromUtf8("background:white;\n"
...
"border: 6px rgb(85, 255, 255);"));
        ...
        pass_edit->setStyleSheet(QString::fromUtf8("background:white;\n"
"border: 6px rgb(85, 255, 255);"));
        ...
        name_edit->setStyleSheet(QString::fromUtf8("background:white;\n"
"border: 6px rgb(85, 255, 255);"));
